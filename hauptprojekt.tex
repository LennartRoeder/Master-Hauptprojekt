...
\begin{document}
	...
	\HAWThesisProperties{Author={Lennart Karsten}
		,Title={Optimierung der GIS Lesegeschwindigkeit in einem Multi-Agenten Simulationssystem}
		,EnglishTitle={Optimizing GIS read performance inside a multi-agent simulation system}
