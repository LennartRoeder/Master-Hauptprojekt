...
%		,EnglishTitle={Optimizing geospatial read performance inside a multi-agent simulation system}
	...
	{This work evaluates and suggests improvements to the geospatial performance of a multi-agent simulation system. The suggestions are evaluated and performance tested. The results allow GIS to be used for millions of agents.}
	%% English abstract
%	{GIS, performance, Multi-agent simulation}%
%	{english abstract.}
