...
\begin{usecase}
	\addtitle{Raster I}{Read all pixels}
...
\begin{usecase}
	\addtitle{Raster II}{Read pixel at position}
	\addfield{Summary:}{Read the closest non null pixel on a specific layer to a GPS position.
	}
	\additemizedfield{Preconditions:}{
		\item The raster file was imported prior to the simulation run.
	}
...
\begin{usecase}
	\addtitle{Raster III}{Calculate distance between Pixels}
	\addfield{Summary:}{A function that takes two pixel coordinates as input and returns the distance in meters.
	}
	\additemizedfield{Preconditions:}{
		\item Both features exist and are available to the layer.
	}
